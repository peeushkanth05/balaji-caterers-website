...
export async function PATCH(req: Request) {
  ...
  try {
    ...
    const updatedSettings = await prisma.siteSetting.upsert({
      ...
      create: {
        id: "default",
        companyName: companyName || "Verma Caterers",
        ...
        seoTitle: seoTitle || "Verma Caterers | Best Catering & Event Services in Delhi NCR",
        ...
        aboutTitle: aboutTitle || "Why Choose Verma Caterers",
