  ...
  try {
    ...
    const updatedHero = await prisma.heroSection.upsert({
      ...
      create: {
        ...
        subheading: body.subheading || "From grand royal weddings to intimate family gatherings — Shree Balaji Caterers brings you world-class catering, stunning floral décor, seamless sound, and complete event management.",
