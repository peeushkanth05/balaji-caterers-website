    ...
    if (menus.length === 0) {
      const defaultMenus = [
        { label: "Home", link: "/", displayOrder: 0 },
        {
          ...
          displayOrder: 1,
          submenus: [
            { label: "Catering & Gastronomy", link: "/#services", displayOrder: 0 },
            { label: "Floral & Decor Design", link: "/#services", displayOrder: 1 },
            { label: "DJ & Sound Stage", link: "/#services", displayOrder: 2 },
          ],
        },
